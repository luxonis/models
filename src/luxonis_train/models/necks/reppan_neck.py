    ...
    def __init__(
        ...
        **kwargs
        ...
        self.Rep_p4 = RepVGGBlockN(
            ...
            num_blocks=num_repeats[0],
        )

        self.Rep_p3 = RepVGGBlockN(
            in_channels=prev_out_shapes[prev_out_start_idx][1] + channels_list[1],
            out_channels=channels_list[1],
            num_blocks=num_repeats[1],
        )

        self.Rep_n3 = RepVGGBlockN(
            in_channels=channels_list[1] + channels_list[2],
            out_channels=channels_list[3],
            num_blocks=num_repeats[2],
        )

        self.Rep_n4 = RepVGGBlockN(
            in_channels=channels_list[0] + channels_list[4],
            out_channels=channels_list[5],
            num_blocks=num_repeats[3],
        )
