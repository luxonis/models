...
from luxonis_train.utils.registry import MODULES
...
class Config:
    ...
    def _validate_config(self) -> None:
        ...
        model_cfg = self._data["model"]
        model_predefined = model_cfg.get("type") is not None
        backbone_specified = "backbone" in model_cfg and model_cfg["backbone"]
        "neck" in model_cfg and model_cfg["neck"]
...
def get_head_label_types(head_str: str) -> List[LabelType]:
    ...
    return MODULES.get(head_str).label_types
